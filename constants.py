'''
Contains relevant constants for the project
'''
...
gw_data = [
    'history_data\merged_gw_1718.csv',
    'history_data\merged_gw_1819.csv',
    'history_data\merged_gw_1920.csv'
]

player_history = [
    'history_data\players_raw_1718.csv',
    'history_data\players_raw_1819.csv',
    'history_data\players_raw_1920.csv'
]